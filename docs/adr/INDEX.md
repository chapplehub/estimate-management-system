...
| [20260716-35a](20260716-35a-type-enforce-no-fixed-discounts-on-repriced-generation.md) | 単価再解決を伴う生成の固定値引不変則を型で強制する（repriced 記述子＋子構築の共有ビルダー一本化） | 採用（決定1・型ガード条項は 20260717-w4d へ置換） | 2026-07-16 |
| [20260717-w4d](20260717-w4d-additive-descriptor-base-over-subtractive-commonalization.md) | 引き継ぎ生成の記述子は痩せた共有核を加算拡張して組み立て、減算共通化（Omit / Required&lt;Omit&lt;&gt;&gt;）を用いない | 採用 | 2026-07-17 |
...
| [20260829-9f1](20260829-9f1-pin-ec2-release-to-head-commit-derive-image-tag.md) | EC2 の稼働リリースをクローンの HEAD commit に固定し、イメージタグをそこから導出する | 採用 | 2026-08-29 |
