...
| [0069](0069-close-submit-toctou-window-by-atomic-version-bump-and-insert.md) | 申請 submit の version bump と申請挿入を単一トランザクションで原子化し、兄弟二重前進の TOCTOU 窓を閉じる | 採用 | 2026-06-26 |
