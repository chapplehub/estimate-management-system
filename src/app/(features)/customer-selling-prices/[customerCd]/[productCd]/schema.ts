...
/**
 * 得意先別販売単価 適用期間の操作別バリデーションスキーマ（UC-3/4/5）。
 *
 ...
 *
 * 共通販売単価（`common-selling-prices/[productCd]/schema.ts`）の同型写像で、宛先キーが
 * 得意先コード × 商品コードの複合になる点だけが異なる（ADR-20260627-a5c）。
 */
...
/** 得意先別販売単価（0以上の整数。マスタ正規入力として0円を許容＝use-cases.md ルール3）。 */
