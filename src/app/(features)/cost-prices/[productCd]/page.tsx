...
import { costPriceEditQueryFactory } from "@subdomains/pricing/application/factories/pricingQueryFactory";
...
export default async function CostPriceDetailPage({
  params,
}: {
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="mb-8">
        <Link href="/cost-prices" className="text-blue-600 hover:text-blue-800 hover:underline">
          ← 原価一覧に戻る
        </Link>
      </div>
