...
import type { CostPriceEditPeriodDTO } from "@subdomains/pricing/application/queries/dto/CostPriceEditDTO";
...
export function PeriodForm({
  ...
  const defaultValue = {
    ...
    price: period != null ? period.costPrice.split(".")[0] : undefined,
  };
  ...
  return (
    <div className="bg-white border rounded px-6 pt-5 pb-6 mt-4">
      ...
      <form {...getFormProps(form)} noValidate className="space-y-4">
        {/* 未設定商品の初回登録（version=null）では version を送らず BE に新規作成を選ばせる（#502）。 */}
        {version != null && (
