...
/**
 * 周辺商品サジェストダイアログ（D6・計画§6・#619）。
 *
 * 明細行の「周辺追加」ボタン押下で表示し（自動割り込みは廃止・#619）、有効な周辺商品を
 * 「既定チェック済み（追加寄り）」で提案する。確定した周辺は通常行として本体直下に挿入される
 * （親に金額集約しない）。追加した周辺行が自身も周辺を持てば、その行のボタンから同様に開ける
 * （カスケード許可・#619）。
 */
