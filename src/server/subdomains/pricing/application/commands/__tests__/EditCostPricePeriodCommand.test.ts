...
import { EditCostPricePeriodCommand } from "../EditCostPricePeriodCommand";

const TEST_PRODUCT_CODE = "CPCMD20";
...
describe("EditCostPricePeriodCommand", () => {
  let command: EditCostPricePeriodCommand;
  ...
  beforeEach(async () => {
    ...
    command = new EditCostPricePeriodCommand(repository);
  ...
  it("将来行の単価・期間を編集できる", async () => {
    ...
    expect(found!.periods[0].price.equals(cost(1500))).toBe(true);
