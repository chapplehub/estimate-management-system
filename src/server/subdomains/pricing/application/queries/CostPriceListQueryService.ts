import { CostPriceListItemDTO, CostPricePriceStatus } from "./dto/CostPriceListItemDTO";
 ...
 */
export interface CostPriceListQueryService {
  /**
   * 全商品に現在有効原価を添えた一覧を、検索条件で絞り込んで返す。
   *
